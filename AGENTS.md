...
この repo は `api-json-csv-translation-compare` の closed alpha 実装単位です。

## Scope

- Root: `D:\AI\WindowsApp\api-json-csv-translation-compare`
- Domain: WindowsApp
- Product kind: windows-app
- Source pack: `D:/AI/WindowsApp/created_idea_011_api-json-csv-translation-compare/idea_011_api-json-csv-translation-compare.zip`
- Public repo: `https://github.com/Sunmax0731/api-json-csv-translation-compare`

## Working Rules

- README、AGENTS、SKILL、docs を同じ変更単位で更新する。
- created_idea は `D:/AI/WindowsApp/created_idea_011_api-json-csv-translation-compare` を正とし、同梱 ZIP の `metadata.json` と repo 名が一致することを確認する。
